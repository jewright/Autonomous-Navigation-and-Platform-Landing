...
if __name__ == '__main__':          
    try:
        ...
        # rospy.Subscriber('/custom2/command', String, command_cb)

        # landcmd = rospy.Publisher("/fromJackal1/landcmd", String, queue_size=10)
        ...
        while not rospy.is_shutdown():
            rate.sleep()
            cmd = raw_input("command: \"s\" to stop the UGV and \"q\" for exit the main loop: ")
            # print(cmd)
            if cmd=='s':
                stopThread = True
            elif cmd=='q':
